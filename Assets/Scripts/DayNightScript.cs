...
public class DayNightScript : MonoBehaviour
{
    ...
    private bool isDay => hour >= dawnTime && hour < 24.0f - dawnTime;
    ...
    void Update()
    {
        ...
        float coef;
        if (hour >= dawnTime && hour < 24.0f - dawnTime)
        {
        ...
        else //нічна фаза
        {
            ...
            coef = 0.3f * Mathf.Sin((arg - (-dawnTime)) * Mathf.PI / (24.0f - 2.0f * dawnTime));
            moon.intensity = coef;
        ...
        transform.Rotate(0, 0, -360.0f * dTime);
    }
